...
class Loss_CategoricalCrossentropy(Loss):
    ...
    def forward(self,y_pred,y_true):
        ...
        if len(y_true.shape) == 1:
            #range(samples) is the index of y_true which is then the index of
            #y_pred_clipped --> thus correct_confidences is a list of
            #y_pred_clipped[y_true[range(samples)]] .
...
#%% Catagorical-cross entropy classification
